...
<html>
    ...
    <div>
        ...
        <ul class="nav nav-tabs justify-content-center">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle active" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Bitacora</a>
    ...
    <br>
    <h3 style="text-align: center;font-family: sans-serif">Editar Bitácora</h3>
    
    <form action="EditarBitacora" method="post" style="text-align: center">
        
        <div style="text-align: center">
            <table cellspacing="3" cellpadding="18" border="0" style="margin: 0 auto">
                <tr>
                    <td align="right"> Nombre: </td>
                    <td><input type="text" name="nom" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required></td>
                </tr>
                <tr>
                    <td align="right"> Informe: </td>
                    <td><textarea type="text" name="data" class="form-control" aria-label="" id="validationDefaultUsername"></textarea></td>
                </tr>
            </table>
