...
<html>
    ...
    <div>
        ...
        <nav class="navbar navbar-dark bg-primary" style="background-color: #e3f2fd;">
            <div class="container-fluid">
                ...
                <form action="InfUsuario">
                    <input class="btn btn-secondary btn-lg disabled" type="submit" value="Informacion del usuario">
                </form>
                <form action="Bitacora.jsp">
                    <input class="btn btn-primary" type="submit" value="Bitacora">
                </form>
                <form action="ModificarUsuario.jsp">
                    <input class="btn btn-primary" type="submit" value="Editar Usuario">
                </form>
                <form action="Ayuda.jsp">
                    <input class="btn btn-primary" type="submit" value="Ayuda">
                </form>
    ...
    <%@ page import="Service.Usuarios, java.util.ArrayList" %>
    <h2 style="text-align: center">Los Libros que están registrados son: </h2>
    <%
        ArrayList<Usuarios> libros = null;
        libros = (ArrayList<Usuarios>) request.getAttribute("Usuarios");
    %>
    <table class="table table-dark table-striped" border="1">
        ...
        <%
            for (Usuarios libro : libros) {
        %>
        <tr valign="top">
            <td><%=libro.getUsu()%></td>
            <td><%=libro.getNombre()%></td>
            <td><%=libro.getEps()%></td>
            <td><%=libro.getGmail()%></td>
        </tr>
        <% }%>
    </table>
