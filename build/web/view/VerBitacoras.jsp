...
<html>
    ...
    <br>
    <%@ page import="Service.Bitacora, java.util.ArrayList" %>
    <h2 style="text-align: center">Listado: </h2>
    
    <%
        ArrayList<Bitacora> autor = null;
        autor = (ArrayList<Bitacora>) request.getAttribute("Bitacora");
    %>
    <div class="container">
        <table class="table table-light table-striped table-bordered" border="1">
            <tr>
            ...
            <%
                for (Bitacora autors : autor) {
            %>
            <tr valign="top">
                <td ><%=autors.getNombre()%></td>
                <td ><%=autors.getData()%></td>
                <td ><%=autors.getDate()%></td>
            </tr>
            <% }%>
        </table>
    </div>
    <p> Número de registros : <%= autor.size()%></p>
    <% autor.clear();%>
    <br>
