    ...
    <body>
        <div>
            ...
            <ul class="nav nav-tabs justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="Enlistar">Documentos</a>
                </li>
                <li class="nav-item">
        ...
        <!-- Modelo de Subir Archivos -->
        <br>

        <%@ page import="Service.Archivos, java.util.ArrayList" %>
        <%
            ArrayList<Archivos> autor = null;
            autor = (ArrayList<Archivos>) request.getAttribute("Doc");
        %>
        <div class="container">

            <center>
                <h1> Almacena tus Documentos</h1>
                <p>
                    ¡Ten todos tus archivos o documentos médicos en un solo lugar y en cualquier lugar!
                </p>
            </center>
        ...
        <br>
        <div class="container">
            <table class="table table-light table-striped table-bordered" cellspacing="3" cellpadding="3" border="1" style="margin: 0 auto">
                <tr align="center">
                    <th>Nombre</th>

                </tr>
                <%
                    for (Archivos autors : autor) {
                %>
        ...
        <br><br>
        <center>
            <h4 style="font-family: sans-serif"> Descargar archivo:</h4>
        </center>
        <form action="Descargar" method="post" style="text-align: center">

            <div style="text-align: center">
                <table cellspacing="3" cellpadding="16" border="0" style="margin: 0 auto">
                    <tr>
                        <td align="right"> Nombre del documento: </td>
                        <td><input type="text" name="file" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required></td>
                    </tr>
                </table>
        ...
        <center>
            ...
            <h4 style="font-family: sans-serif"> Añadir archivo:</h4>

        </center>
        <form method="post" action="Upload" enctype="multipart/form-data" style="text-align: center">

            <input class="btn btn-lg" type="file" name="uploadFile" />
            <br>
            <div class="d-grid gap-2 col-4 mx-auto">
