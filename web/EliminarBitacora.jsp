...
<html>
    ...
    <br>
    <h3 style="text-align: center;font-family: sans-serif" >Eliminar Bitácora</h3>
    
    <form action="EliminarBitacora" method="post" style="text-align: center">
        <div style="text-align: center">
            <table cellspacing="3" cellpadding="21" border="0" style="margin: 0 auto">
                <tr>
                    <td align="right"> Nombre de la Bitacora: </td>
                    <td><input type="text" name="bit" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" required></td>
                </tr>
            </table>
