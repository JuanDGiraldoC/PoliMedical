...
<html>
    ...
    <style>
        ...
        <body>
            <div>
                ...
                <ul class="nav nav-tabs justify-content-center">
                    <li class="nav-item" >
                        <a class="nav-link active" aria-current="page" href="InicioAdmin.jsp">Inicio</a>
                    </li>
                    <li class="nav-item">
        ...
        <div style="text-align: center">
            <img src="Inicio.jpg" width="900" height="450" alt="alt"/>
        </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel"> Llevando al día tú Salud</h5>

                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>

                    <div class="modal-body">
                        <center><embed src="polimedical.mp4" width="750" height="450"></center>
