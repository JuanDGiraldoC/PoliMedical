...
public class InfUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            autors = LeeUsuarios.leeUsuario("C:/Proyecto Integrador/PoliMedical/Usuarios.txt");
            request.setAttribute("Libros", autors);
